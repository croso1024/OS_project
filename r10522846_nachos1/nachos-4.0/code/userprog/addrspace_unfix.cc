...
// 1017
// bool
// AddrSpace::phyPageState[NumPhysPages] = {UNUSED} ;  
...
AddrSpace::~AddrSpace()
{
    ...
    // {
    //     AddrSpace::phyPageState[pageTable[i].physicalPage] = UNUSED ; 
...
// modify 1017 
    ...
    // for (; i < numPages; i+=1 )
    // {
    //     while( (phyPageId<NumPhysPages) && (AddrSpace::phyPageState[phyPageId] == OCCU )) {phyPageId += 1;}
    //     AddrSpace::phyPageState[phyPageId] = OCCU ;  
